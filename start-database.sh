...
DB_CONTAINER_NAME="quant-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=quant -d -p 5432:5432 docker.io/postgres
